...
public class MNT883_AddEditCareer {
    ...
    @Test(description = "Verify that the user can add/edit career")
    @Description("When a user adds or edits career, career details should be updated")
    @Severity(SeverityLevel.CRITICAL)
    @Story("MNT883: Add/Edit Career")
    public void verifyCareerAddAndEdit() throws InterruptedException {
        professionalPage.verifyAddCareer();
        professionalPage.verifyEditCareer();
    }
